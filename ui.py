...
def show_game_over_screen(screen, score, collision_count, level_num, correct_answers, correct_answers_streak, high_scores):
    '''
    falta adicionar o resultado em high_scores.txt
    ...
    #draw_text(screen, f"Pontuação: {score}", 36, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 50, color=(255, 255, 255), align="center")
    ...
    # Exibe os melhores scores
    #draw_text(screen, "Melhores Pontuações:", 36, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 200, color=(255, 255, 255), align="center")
    #y_offset = SCREEN_HEIGHT // 2 + 250
    # for score, date in high_scores[:10]:  # Limita a 10 melhores pontuações
    #     draw_text(screen, f"{score} - {date}", 24, SCREEN_WIDTH // 2, y_offset, color=(255, 255, 255), align="center")
    #     y_offset += 30
